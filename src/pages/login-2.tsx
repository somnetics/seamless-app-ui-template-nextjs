  ...
  return (
    <main className={styles.LoginBg + " flex h-screen min-h-full flex-col justify-center px-6 py-12 lg:px-8"}>
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div>
          <div className={"relative grid gap-6 py-12 px-8 w-full text-slate-100 bg-black/20 backdrop-blur-sm text-sm rounded-xl shadow-lg z-1"}>
            <div className="flex gap-1 flex-col items-center justify-center">
              <h1 className="text-xl font-bold">Welcome Back</h1>
              <p className="text-slate-400">Lets start building something interesting.</p>
            </div>
            <div className="flex flex-col gap-2">
              <label htmlFor="" className="">
                Username
              </label>
              <input type="text" className="w-full rounded-lg p-2 border-2 border-slate-700 focus:ring-blue-500 focus:outline-blue-500" />
            </div>
            <div className="flex flex-col gap-2">
              <label htmlFor="" className="">
                Password
        ...
        <div className="flex flex-col gap-1 items-center text-sm justify-center mt-8">
          ...
          <p className="text-slate-400 font-thin">&copy; 2025 Som Imaging Informatics Pvt. Ltd.</p>
          {/* <Image src="/icons/logo-light.svg" alt="" height={40} width={175} /> */}
          {/* <span className="inline-flex items-center rounded-md bg-purple-400/10 px-2 py-1 text-xs font-medium text-purple-400 inset-ring inset-ring-purple-400/30">Beta v4.0</span> */}
        </div>
      </div>
      {/* <footer className="fixed bottom-0 left-0 right-0 bg-slate-800/40 backdrop-blur-sm text-white p-4 z-50">
