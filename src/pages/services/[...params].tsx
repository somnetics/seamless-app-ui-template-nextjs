          ...
          <div className="mb-4 border-b border-gray-200 dark:border-gray-700 bg-white">
            <ul className="flex flex-wrap -mb-px text-sm font-medium px-12 text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
              <li className="me-3" role="presentation">
                <button className="inline-block p-4 border-b-2 rounded-t-lg cursor-pointer text-gray-500 hover:text-gray-800 border-gray-300 hover:border-gray-600" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">API Keys</button>
              </li>
              <li className="me-3" role="presentation">
                <button className="inline-block p-4 border-b-2 rounded-t-lg cursor-pointer text-gray-500 hover:text-gray-800 border-gray-300 hover:border-gray-600" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">OAuth 2.0 Client IDs</button>
              </li>
              <li className="me-3" role="presentation">
                <button className="inline-block p-4 border-b-2 rounded-t-lg cursor-pointer" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="true">OAuth 2.0 Client IDs</button>
              </li>
            </ul>
          </div>
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="text-left p-2.5">
                      <a href="#" className="flex items-center">
                        <span className="me-2">3569709469305-rdf...</span><Copy size={15} className="text-green-600" />
                      </a>
                    </td>
                    <td className="text-left p-2.5">
