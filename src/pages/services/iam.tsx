...
export default function ApiDetails({ meta, service }: PageProps) {
  ...
  const userForm = <>
    <div>
      ...
      <input type="text" className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Enter First Name" />
    </div>
    <div>
      <label className="block text-sm font-medium text-slate-700">Last Name</label>
      <input type="text" className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Enter Last Name" />
    </div>
    <div>
      <label className="block text-sm font-medium text-slate-700">User Name</label>
      <input type="text" className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Enter Username" />
    </div>
    <div>
      <label className="block text-sm font-medium text-slate-700 mb-2">Gender</label>
      <select id="status" name="status" className="block w-full rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm text-slate-700 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none" >
    ...
    <div>
      ...
      <input type="email" className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Enter email" />
    </div>
    <div>
    ...
    <div>
      ...
      <input type="tel" className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" placeholder="Enter mobile number" />
    </div>
    <div>
    ...
    <>
      ...
      <main className="min-h-screen xl:flex">
        ...
        <div className="flex-1 transition-all duration-300 ease-in-out lg:ml-[85px]">
          ...
          {/* <SideDrawerForm /> */}
          <div className="flex w-full item-center justify-between border-b border-slate-200 py-3 px-12">
          ...
          <div className="px-12 bg-white">
            <div className="w-full p-4 mx-auto1 border-b1 border-slate-2001">
          ...
          <div className="mb-4 border-b border-slate-200 dark:border-slate-700 bg-white">
            <ul className="flex flex-wrap -mb-px text-sm font-medium px-12 text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
              <li className="me-3" role="presentation">
                <button className="inline-block p-4 border-b-2 rounded-t-lg cursor-pointer text-slate-500 hover:text-slate-800 border-slate-300 hover:border-slate-600" id="user-tab" data-tabs-target="#users" type="button" role="tab" aria-controls="users" aria-selected="false">Users</button>
              </li>
              <li className="me-3" role="presentation">
                <button className="inline-block p-4 border-b-2 rounded-t-lg cursor-pointer text-slate-500 hover:text-slate-800 border-slate-300 hover:border-slate-600" id="group-tab" data-tabs-target="#groups" type="button" role="tab" aria-controls="groups" aria-selected="false">Groups</button>
              </li>
              <li className="me-3" role="presentation">
                <button className="inline-block p-4 border-b-2 rounded-t-lg cursor-pointer text-slate-500 hover:text-slate-800 border-slate-300 hover:border-slate-600" id="role-tab" data-tabs-target="#roles" type="button" role="tab" aria-controls="roles" aria-selected="false">Roles</button>
              </li>
            </ul>
          </div>
          <div id="default-tab-content">
            <div className="hidden1 p-4 rounded-lg dark:bg-slate-800 px-12" id="users" role="tabpanel" aria-labelledby="user-tab">
            ...
            <div className="hidden p-4 rounded-lg  dark:bg-slate-800" id="groups" role="tabpanel" aria-labelledby="group-tab">
              <table className="table-auto w-full text-sm">
                <thead className="bg-slate-200">
                  <tr>
                    <th className="w-[20px] px-4 py-2.5">
            ...
            <div className="hidden p-4 rounded-lg  dark:bg-slate-800" id="role" role="tabpanel" aria-labelledby="role-tab">
              <p className="text-sm text-slate-500 dark:text-slate-400">This is some placeholder content the <strong className="font-medium text-slate-800 dark:text-white">Settings tab&apos;s associated content</strong>. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling.</p>
            </div>
          </div>
        </div>
      </main>
