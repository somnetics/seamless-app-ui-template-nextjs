    ...
    <>
      <Page session={session} title="Seamless Developer Console" breadcrumbs={[
        ...
        <div className="relative mx-auto flex flex-col">
          <TabContent ulClassName="px-12 my-3" containerClassName="w-full mx-auto max-w-[1400px]" tabs={[
            { name: "Account", icon: "UserCog", link: "/admin/account", content: <Account /> },
            { name: "Organisation", icon: "Building2", link: "/admin/organisation", content: <Organisation session={session} /> },
