...
import { Trash2, Download, Edit2, Copy, Plus } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-4 text-slate-400">
        <Link href="/registration/user" className="fixed bottom-6 right-6 bg-slate-500/80 backdrop-blur-md hover:bg-slate-600/90
           text-white w-14 h-14 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110">          
